            ...
            <nav class="nav-links">
                ...
                <?php if (isset($_SESSION['perfil'])): ?>
                    <?php if ($_SESSION['perfil'] === 'FORNECEDOR'): ?>
                        ...
                        <a href="<?php echo BASE_URL; ?>/views/dashboards/pedidos/index.php">Pedidos</a>
                        <div class="dropdown">
                            <a href="javascript:void(0)" class="dropdown-toggle">Perfil <i class="fas fa-chevron-down"></i></a>
