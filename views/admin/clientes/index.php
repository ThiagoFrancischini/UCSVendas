...
<div id="modal-cliente" class="adm-modal" style="display:none">
        ...
        .then(function(data) {
            ...
            tbody.innerHTML = data.clientes.map(function(c) {
                return '<tr>' +
                    ...
                    '<button class="btn-tabela btn-detalhe-sm" onclick="abrirModal(' + c.id + ')"><i class="fas fa-eye"></i> Detalhes</button>' +
...
function abrirModal(clienteId) {
    ...
    fetch(window.BASE_URL + '/api/detalhe_cliente.php?id=' + clienteId)
        .then(function(r) { return r.json(); })
        .then(function(data) {
            if (!data.sucesso) {
            ...
            document.getElementById('modal-corpo').innerHTML =
                '<div class="detalhe-grid">' +
                    '<div class="detalhe-stat full">' +
                        ...
                        '<div class="detalhe-stat-info"><strong>' + c.num_pedidos + '</strong><span>Pedido(s) realizados</span></div>' +
                    '</div>' +
                    '<div class="detalhe-secao">Dados Pessoais</div>' +
                    '<div class="detalhe-item full"><span class="detalhe-label">Nome</span><span class="detalhe-valor">' + esc(c.nome) + '</span></div>' +
                    '<div class="detalhe-item"><span class="detalhe-label">E-mail</span><span class="detalhe-valor">' + esc(c.email) + '</span></div>' +
                    '<div class="detalhe-item"><span class="detalhe-label">Telefone</span><span class="detalhe-valor">' + esc(c.telefone || '—') + '</span></div>' +
                    '<div class="detalhe-secao">Endereço</div>' +
                    '<div class="detalhe-item full"><span class="detalhe-label">Logradouro</span><span class="detalhe-valor">' + esc(c.endereco || '—') + '</span></div>' +
                    '<div class="detalhe-item"><span class="detalhe-label">Bairro</span><span class="detalhe-valor">' + esc(c.bairro || '—') + '</span></div>' +
                    '<div class="detalhe-item"><span class="detalhe-label">CEP</span><span class="detalhe-valor">' + esc(c.cep || '—') + '</span></div>' +
                    '<div class="detalhe-item"><span class="detalhe-label">Cidade</span><span class="detalhe-valor">' + esc(c.cidade || '—') + '</span></div>' +
                    '<div class="detalhe-item"><span class="detalhe-label">Estado</span><span class="detalhe-valor">' + esc(c.estado || '—') + '</span></div>' +
                '</div>';
        });
}
